...
describe("Email Verification Token Expiration:", () => {
  ...
  it_id("f20dd3c2-87d9-4bc6-a51d-4ea2834acbcc")(it)(
  ...
  it_id("94956799-c85e-4297-b879-e2d1f985394c")(it)(
  ...
  it_id("25f3f895-c987-431c-9841-17cb6aaf18b5")(it)(
    ...
    async () => {
      ...
      expect(response.status).toEqual(302);
      const verifiedUser = await Parse.User.logIn(
        "testEmailVerifyTokenValidity",
        "expiringToken"
      );
  ...
  it_id("c6a3e188-9065-4f50-842d-454d1e82f289")(it)(
  ...
  it_id("9365c53c-b8b4-41f7-a3c1-77882f76a89c")(it)(
    "can conditionally send emails",
    async () => {
      let sendEmailOptions;
      const emailAdapter = {
        sendVerificationEmail: options => {
  ...
  it_id("b3549300-bed7-4a5e-bed5-792dbfead960")(it)(
    "can conditionally send emails and allow conditional login",
    async () => {
      let sendEmailOptions;
      const sendPromise = resolvingPromise();
      const emailAdapter = {
  ...
  it_id("d812de87-33d1-495e-a6e8-3485f6dc3589")(it)(
    "can conditionally send user email verification",
    async () => {
      const emailAdapter = {
        sendVerificationEmail: () => {},
        sendPasswordResetEmail: () => Promise.resolve(),
  ...
  it_id("d98babc1-feb8-4b5e-916c-57dc0a6ed9fb")(it)(
    "provides full user object in email verification function on email and username change",
    async () => {
      const emailAdapter = {
        sendVerificationEmail: () => {},
        sendPasswordResetEmail: () => Promise.resolve(),
  ...
  it_id("a8c1f820-822f-4a37-9d08-a968cac8369d")(it)(
    "beforeSave options do not change existing behaviour",
    async () => {
      let sendEmailOptions;
      const sendPromise = resolvingPromise();
      const emailAdapter = {
  ...
  it_id("36d277eb-ec7c-4a39-9108-435b68228741")(it)(
    ...
    async () => {
      ...
      expect(typeof verifiedUser._email_verify_token_expires_at).toBe(
        "undefined"
      );
    }
  );

  it_id("4f444704-ec4b-4dff-b947-614b1c6971c4")(it)(
  ...
  it_id("b6c87f35-d887-477d-bc86-a9217a424f53")(it)(
  ...
  it_id("28f2140d-48bd-44ac-a141-ba60ea8d9713")(it)(
  ...
  it("provides function arguments in verifyUserEmails on verificationEmailRequest", async () => {
    ...
    const verifyUserEmailsSpy = spyOn(
      verifyUserEmails,
      "method"
    ).and.callThrough();
    await reconfigureServer({
    ...
    await expectAsync(
      Parse.User.requestEmailVerification("test@example.com")
    ).toBeResolved();
  ...
  it_id("0e66b7f6-2c07-4117-a8b9-605aa31a1e29")(it)(
    "should match codes with emailVerifyTokenReuseIfValid",
    async () => {
      let sendEmailOptions;
      let sendVerificationEmailCallCount = 0;
      const promise1 = resolvingPromise();
      ...
      expect(userBeforeRequest._email_verify_token).toEqual(
        userAfterRequest._email_verify_token
      );
  ...
  it_id("b082d387-4974-4d45-a0d9-0c85ca2d7cbf")(it)(
