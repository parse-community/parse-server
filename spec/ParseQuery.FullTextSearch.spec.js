...
describe('Parse.Query Full Text Search testing', () => {
  ...
  it_id('dade10c8-2b9c-4f43-bb3f-a13bbd82ac22')('fullTextSearch: $search, invalid input', async () => {
    await fullTextHelper();
  ...
  it_id('ff7c6b1c-4712-4847-bb76-f4e1f641f7b5')('fullTextSearch: $language, invalid input', async () => {
    await fullTextHelper();
    const query = new Parse.Query('TestObject');
  ...
  it_id('de262dbc-ec75-4ec6-9217-fbb90146c272')('fullTextSearch: $caseSensitive, invalid input', async () => {
    await fullTextHelper();
    const query = new Parse.Query('TestObject');
  ...
  it_id('b7b7b3a9-8d6c-4f98-a0ff-0113593d06d4')('fullTextSearch: $diacriticSensitive, invalid input', async () => {
    await fullTextHelper();
    const query = new Parse.Query('TestObject');
