...
describe('Hooks', () => {
    ...
    'should CRUD a function registration',
      ...
      Parse.Hooks.createFunction('My-Test-Function', 'http://someurl')
        ...
        .then(response => {
          ...
          expect(response.url).toBe('http://someurl');
          return Parse.Hooks.updateFunction(
            'My-Test-Function',
            'http://anotherurl'
          );
        })
          ...
          return Parse.Hooks.getFunction('My-Test-Function').then(
            ...
            err => {
              ...
              expect(err.message).toBe(
                'no function named: My-Test-Function is defined'
              );
              done();
              return Promise.resolve();
            }
  ...
  it_id('7a81069e-2ee9-47fb-8e27-1120eda09e99')(it)(
      ...
      Parse.Hooks.createTrigger('MyClass', 'beforeDelete', 'http://someurl')
        ...
        .then(
          res => {
            ...
            expect(res.url).toBe('http://someurl');
            // delete
            return Parse.Hooks.updateTrigger(
              'MyClass',
              'beforeDelete',
              'http://anotherurl'
            );
  ...
  it_id('f7ad092f-81dc-4729-afd1-3b02db2f0948')(it)(
    'should fail trying to create two times the same function',
      ...
      Parse.Hooks.createFunction('my_new_function', 'http://url.com')
        ...
        .then(
          () => {
            return Parse.Hooks.createFunction(
              'my_new_function',
              'http://url.com'
            );
          },
        ...
        .then(
          ...
          err => {
            ...
            if (err) {
              expect(err.code).toBe(143);
              expect(err.message).toBe(
                'function name: my_new_function already exists'
              );
            }
        ...
        .then(
          ...
          err => {
            ...
            if (err) {
              expect(err.code).toBe(143);
              expect(err.message).toBe(
                'class MyClass already has trigger beforeSave'
              );
            }
      ...
      .then(
        ...
        err => {
          ...
          if (err) {
            expect(err.code).toBe(143);
            expect(err.message).toBe(
              'no function named: A_COOL_FUNCTION is defined'
            );
          }
  ...
  it_id('96d99414-b739-4e36-b3f4-8135e0be83ea')(it)(
    'should create hooks and properly preload them',
    done => {
      const promises = [];
      for (let i = 0; i < 5; i++) {
        promises.push(
          Parse.Hooks.createTrigger(
            'MyClass' + i,
            'beforeSave',
            'http://url.com/beforeSave/' + i
          )
        );
        promises.push(
          Parse.Hooks.createFunction(
            'AFunction' + i,
            'http://url.com/function' + i
          )
        );
      }
        ...
        .then(
          function () {
            for (let i = 0; i < 5; i++) {
              ...
              expect(
                triggers.getFunction('AFunction' + i, Parse.applicationId)
              ).toBeUndefined();
            }
  ...
  it_id('fe7d41eb-e570-4804-ac1f-8b6c407fdafe')(it)(
  ...
  it_id('63985b4c-a212-4a86-aa0e-eb4600bb485b')(it)(
    'should run the function on the test server (error handling)',
    done => {
      ...
      Parse.Hooks.createFunction(
        'SOME_TEST_FUNCTION',
        hookServerURL + '/SomeFunctionError'
      )
        .then(
          function () {
            return Parse.Cloud.run('SOME_TEST_FUNCTION');
  ...
  it_id('bacc1754-2a3a-4a7a-8d0e-f80af36da1ef')(it)(
  ...
  it_id('eeb67946-42c6-4581-89af-2abb4927913e')(it)(
    'should not pass X-Parse-Webhook-Key if not provided',
      ...
      reconfigureServer({ webhookKey: undefined }).then(() => {
        ...
        Parse.Hooks.createFunction(
          'SOME_TEST_FUNCTION',
          hookServerURL + '/ExpectingKeyAlso'
        )
          .then(
            function () {
              return Parse.Cloud.run('SOME_TEST_FUNCTION');
  ...
  it_id('21decb65-4b93-4791-85a3-ab124a9ea3ac')(it)(
  ...
  it_id('52e3152b-5514-4418-9e76-1f394368b8fb')(it)(
  ...
  it_id('d27a7587-abb5-40d5-9805-051ee91de474')(it)(
