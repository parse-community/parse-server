...
describe('DatabaseController', () => {
  ...
  describe('addPointerPermissions', () => {
    ...
    it('should not return an $or operation if the query involves one of the two fields also used as array/pointer permissions', () => {
    ...
    it('should not return an $or operation if the query involves one of the fields also used as array/pointer permissions', () => {
      const clp = buildCLP(['user', 'users', 'userObject']);
      const query = { a: 'b', user: createUserPointer(USER_ID) };
      schemaController.testPermissionsForClassName
        .withArgs(CLASS_NAME, ACL_GROUP, OPERATION)
  ...
  describe('transformEmailAndUsernameToLowerCase', () => {
    const dummyStorageAdapter = {
    ...
    it('should not transform email and username to lower case without transformEmailAndUsernameToLowerCase option on create', async () => {
      const databaseController = new DatabaseController(dummyStorageAdapter, {});
    ...
    it('should transform email and username to lower case with transformEmailAndUsernameToLowerCase option on create', async () => {
      const databaseController = new DatabaseController(dummyStorageAdapter, {
        transformEmailAndUsernameToLowerCase: true,
      });
      const spy = spyOn(dummyStorageAdapter, 'createObject');
      spy.and.callThrough();
      await databaseController.create('_User', {
    ...
    it('should not transform email and username to lower case without transformEmailAndUsernameToLowerCase option on update', async () => {
      const databaseController = new DatabaseController(dummyStorageAdapter, {});
    ...
    it('should transform email and username to lower case with transformEmailAndUsernameToLowerCase option on update', async () => {
      const databaseController = new DatabaseController(dummyStorageAdapter, {
        transformEmailAndUsernameToLowerCase: true,
      });
      const spy = spyOn(dummyStorageAdapter, 'findOneAndUpdate');
    ...
    it('should not find a case insensitive user by username or email with transformEmailAndUsernameToLowerCase', async () => {
      await reconfigureServer({ transformEmailAndUsernameToLowerCase: true });
      const user = new Parse.User();
