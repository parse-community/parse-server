    ...
    "group by date object",
      ...
      Parse.Object.saveAll([obj1, obj2, obj3])
        ...
        .then(results => {
          ...
          expect(results[0].objectId.month).toEqual(
    ...
    "group by pointer",
      ...
      Parse.Object.saveAll([pointer1, pointer2, obj1, obj2, obj3])
        ...
        .then(results => {
          ...
          expect(
            results.some(result => result.objectId === pointer1.id)
          ).toEqual(true);
          expect(
            results.some(result => result.objectId === pointer2.id)
          ).toEqual(true);
          expect(results.some(result => result.objectId === null)).toEqual(
            true
          );
          done();
        });
