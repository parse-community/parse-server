...
describe_only_db('postgres')('Parse.Query testing', () => {
  it('fullTextSearch: $diacriticSensitive - false', (done) => {
    fullTextHelper().then(() => {
      const where = {
        subject: {
      ...
      fail(`$diacriticSensitive should not exist: ${JSON.stringify(resp)}`);
      done();
    }).catch((err) => {
      expect(err.error.code).toEqual(Parse.Error.INVALID_JSON);
      done();
  ...
  it('fullTextSearch: $caseSensitive', (done) => {
    fullTextHelper().then(() => {
      ...
      fail(`$caseSensitive should not exist: ${JSON.stringify(resp)}`);
      done();
    }).catch((err) => {
      expect(err.error.code).toEqual(Parse.Error.INVALID_JSON);
      done();
