...
describe('Pointer Permissions', () => {
  ...
  describe('using single user-pointers', () => {
    ...
    it_id('f38c35e7-d804-4d32-986d-2579e25d2461')('should query on pointer permission enabled column', done => {
      const config = Config.get(Parse.applicationId);
      const user = new Parse.User();
      const user2 = new Parse.User();
      user.set({
  ...
  describe('using arrays of user-pointers', () => {
    ...
    it_id('8a7d188c-b75c-4eac-90b6-9b0b11f873ae')('should query on pointer permission enabled column', async done => {
      const config = Config.get(Parse.applicationId);
      const user = new Parse.User();
      const user2 = new Parse.User();
      const user3 = new Parse.User();
  ...
  describe('Granular ', () => {
    ...
    describe('on single-pointer fields', () => {
      ...
      describe('get action', () => {
        ...
        it_id('9ba681d5-59f5-4996-b36d-6647d23e6a44')('should fail for user not listed', async done => {
          await updateCLP({
            get: {
              pointerFields: ['owner'],
            },
      ...
      describe('update action', () => {
        ...
        it_id('bcdb158d-c0b6-45e3-84ab-a3636f7cb470')('should fail for user not listed', async done => {
          await updateCLP({
            update: {
              pointerFields: ['owner'],
            },
      ...
      describe('delete action', () => {
        ...
        it_id('70aa3853-6e26-4c38-a927-2ddb24ced7d4')('should fail for user not listed', async done => {
          await updateCLP({
            delete: {
              pointerFields: ['owner'],
            },
    ...
    describe('on array of pointers', () => {
      ...
      describe('update action', () => {
        ...
        it_id('2b19234a-a471-48b4-bd1a-27bd286d066f')('should be allowed (multiple users in array)', async done => {
          await updateCLP({
            update: {
              pointerFields: ['moderators'],
            },
      ...
      describe('addField action', () => {
        ...
        it_id('51e896e9-73b3-404f-b5ff-bdb99005a9f7')('should be restricted when updating object without addField permission', async done => {
          await updateCLP({
            update: {
              '*': true,
            },
    ...
    describe('combined with grouped', () => {
      ...
      it_id('b43db366-8cce-4a11-9cf2-eeee9603d40b')('should not limit the scope of grouped read permissions', async done => {
        await updateCLP({
          get: {
            pointerFields: ['owner'],
          },
      ...
      it_id('bbb1686d-0e2a-4365-8b64-b5faa3e7b9cf')('should not limit the scope of grouped write permissions', async done => {
        await updateCLP({
          update: {
            pointerFields: ['owner'],
          },
