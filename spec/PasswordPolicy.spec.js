...
describe('Password Policy: ', () => {
  it_id('b400a867-9f05-496f-af79-933aa588dde5')('should show the invalid link page if the user clicks on the password reset link after the token expires', done => {
  ...
  it_id('7d98e1f2-ae89-4038-9ea7-5254854ea42e')('should keep reset token with resetTokenReuseIfValid', async done => {
    const sendEmailOptions = [];
    const emailAdapter = {
      sendVerificationEmail: () => Promise.resolve(),
      sendPasswordResetEmail: options => {
  ...
  it_id('d7d0a93e-efe6-48c0-b622-0f7fb570ccc1')('should succeed if logged in before password expires', done => {
    const user = new Parse.User();
    reconfigureServer({
      appName: 'passwordPolicy',
      passwordPolicy: {
  ...
  it_id('22428408-8763-445d-9833-2b2d92008f62')('should fail if logged in after password expires', done => {
    const user = new Parse.User();
    reconfigureServer({
      appName: 'passwordPolicy',
      passwordPolicy: {
  ...
  it_id('cc97a109-e35f-4f94-b942-3a6134921cdd')('should apply password expiry policy to existing user upon first login after policy is enabled', done => {
    const user = new Parse.User();
    reconfigureServer({
      appName: 'passwordPolicy',
      publicServerURL: 'http://localhost:8378/1',
  ...
  it_id('d1e6ab9d-c091-4fea-b952-08b7484bfc89')('should reset password timestamp when password is reset', done => {
    const user = new Parse.User();
    const emailAdapter = {
      sendVerificationEmail: () => Promise.resolve(),
      sendPasswordResetEmail: options => {
