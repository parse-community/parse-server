      ...
      describe('Objects Queries', () => {
        ...
        describe('Find', () => {
              ...
              query: gql`
                query FindSomeObjects($where: Object, $limit: Int) {
                  objects {
                    ...
                    findGraphQLClass(where: $where, limit: $limit) {
                      results
                      count
                    }
                  }
          ...
          it('should respect max limit', async () => {
            ...
            expect(result.data.objects.findGraphQLClass.results.length).toEqual(
              10
            );
            expect(result.data.objects.findGraphQLClass.count).toEqual(100);
          });
