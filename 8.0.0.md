...
The request to re-trigger sending an email verification email changed sending a `POST` request to the endpoint `/resend_verification_email` with the `token` in the body.
