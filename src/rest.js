...
function runTriggerAndQuery(className, restWhere, restOptions, config, auth, clientSDK, isGet = false) {
  return triggers.maybeRunQueryTrigger(triggers.Types.beforeFind, className, restWhere, restOptions, config, auth, isGet).then((result) => {
...
function find(config, auth, className, restWhere, restOptions, clientSDK) {
  ...
  return runTriggerAndQuery(className, restWhere, restOptions, config, auth, clientSDK);
}

// get is just like find but only queries an objectId.
const get = (config, auth, className, objectId, restOptions, clientSDK) => {
  const restWhere = { objectId };
  enforceRoleSecurity('get', className, auth);
  return runTriggerAndQuery(className, restWhere, restOptions, config, auth, clientSDK, true);
}
