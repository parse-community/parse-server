...
export class PostgresStorageAdapter {
  ...
  _ensureSchemaCollectionExists() {
    return this._client.none(sql.createSchema)
      .catch(error => {
  ...
  createClass(className, schema) {
    return this.createTable(className, schema)
      .then(() => this._client.none('INSERT INTO "_SCHEMA" ("className", "schema", "isParseClass") VALUES ($<className>, $<schema>, true)', {
        className,
        schema
      }))
      .then(() => {
    ...
    return this._ensureSchemaCollectionExists()
      ...
      .catch(error => {
        ...
        return Promise.all(relations.map((fieldName) => {
          return this._client.none(sql.createTable, {joinTable: `_Join:${fieldName}:${className}`});
        }));
      });
  }
  ...
  performInitialization({VolatileClassesSchemas}) {
    ...
    return this._client.none(sql.createFunc)
      .then(() => {
