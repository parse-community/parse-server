export const ErrorMessage = {
  ...
  invalid: (field, isField = true) =>
    isField === true ? 'The field ' : '' + field + ' is invalid.',
  unauthorizedAccess: (type, value) =>
    'This user is not allowed to access ' + type + ': ' + value + '.',
  notFound: type => type + ' not found.',
  exists: (type, key) => type + '' + key + ' already exists.',
  required: (field, op = ' to save/update the object') =>
    'A value for ' + field + ' is required' + op + '.',
