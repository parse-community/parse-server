 ...
 * @property {String} signupUsernameTaken Log level used when a sign-up fails because the username already exists. Default is `error`. See [LogLevel](LogLevel.html) for available values.
 */
