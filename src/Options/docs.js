 ...
 * @property {String} defaultResultOrder Value for Parse Server's `dns.setDefaultResultOrder` - [NodeJS' DNS lookup](https://nodejs.org/api/dns.html#dnssetdefaultresultorderorder)
