 ...
 * @property {LogEventsOptions} logEvents (Optional) Customize log levels for specific events.
...
/**
 * @interface LogEventsOptions
 * @property {String|boolean} usernameAlreadyExists Log level for the "username already exists" error when trying to sign up. Possible values: 'info', 'error', 'warn', or false to disable logging. If not specified, the default behavior (logging as an error) will be used.
 */
