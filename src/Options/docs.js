 ...
 * @property {Boolean} autoSignupOnLogin Set to `true` to automatically create a user when calling the login endpoint with username/email and password if no matching user exists. Default is `false`.
