 ...
 * @property {Boolean} enableMfa Is true if multi-factor authentication (MFA) can be enabled for users. If a user has MFA enabled, a login requires a code generated by a third-party authenticator (TPA) app. Default is false.
 * @property {String} encryptionKey A secure key that is used to encrypt the multi-factor authentication (MFA) secret of a user. Required if enableMfa is true.
 */
