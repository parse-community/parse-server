 ...
 * @property {Boolean} disableCollation Disable case insensitivity (collation) on queries and indexes, needed if you use MongoDB serverless or AWS DocumentDB
 ...
 * @property {Boolean} transformEmailAndUsernameToLowerCase Transform Username and Email to lowercase on create/update/login/signup. On queries client needs to ensure to send Email/Username in lowercase format.
