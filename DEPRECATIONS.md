...
| DEPPS5 | Remove `Parse.Cloud.beforeSaveFile((request) => {})` in preference to `Parse.Cloud.beforeSave(Parse.File, (request) => {})` | [#7966](https://github.com/parse-community/parse-server/pull/7966)   | 5.3.0 (2022)                    | 7.0.0 (2024)                    | deprecated            | -     |
