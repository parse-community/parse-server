...
| DEPPS6 | Config option `enableAnonymousUsers` defaults to `false` | [#7924](https://github.com/parse-community/parse-server/pull/7924)   | 5.3.0 (2022)                    | 7.0.0 (2024)                    | deprecated            | -     |
