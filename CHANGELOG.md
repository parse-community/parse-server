...
- IMPROVE: Remove wontfix label from stalebot [#6810](https://github.com/parse-community/parse-server/pull/6810). Thanks to [Diamond Lewis](https://github.com/dplewis).
- IMPROVE: Update bug report template [#6805](https://github.com/parse-community/parse-server/pull/6805). Thanks to [Tom Fox](https://github.com/TomWFox).
