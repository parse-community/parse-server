...
- IMPROVE: Parse Server will from now on be continuously tested against all relevant Postgres versions (minor versions). Added Postgres compatibility table to Parse Server docs. [#7176]. Thanks to [Corey Baker](https://github.com/cbaker6).
