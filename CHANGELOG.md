...
- NEW: LiveQuery support for $and, $nor, $containedBy, $geoWithin, $geoIntercept queries [#7113](https://github.com/parse-community/parse-server/pull/7113). Thanks to [dplewis](https://github.com/dplewis)
