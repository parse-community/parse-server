...
var MongoCollection = function () {
  ...
  _createClass(MongoCollection, [{
    ...
    value: function find(query) {
      ...
      return this._rawFind(query, { skip: skip, limit: limit, sort: sort }).catch(function (error) {
        ...
        // Retry, but just once.
        .then(function () {
          return _this._rawFind(query, { skip: skip, limit: limit, sort: sort });
        });
      });
    }
  }, {
    ...
    value: function _rawFind(query) {
      ...
      return this._mongoCollection.find(query, { skip: skip, limit: limit, sort: sort }).toArray();
    }
  }, {
    key: 'count',
    value: function count(query) {
      ...
      return this._mongoCollection.count(query, { skip: skip, limit: limit, sort: sort });
    }
  }, {
    key: 'insertOne',
