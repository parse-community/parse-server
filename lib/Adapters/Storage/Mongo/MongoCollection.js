...
var MongoCollection = function () {
  ...
  _createClass(MongoCollection, [{
    ...
    value: function find(query) {
      ...
      return this._rawFind(query, { skip: skip, limit: limit, sort: sort, keys: keys }).catch(function (error) {
        ...
        // Retry, but just once.
        .then(function () {
          return _this._rawFind(query, { skip: skip, limit: limit, sort: sort, keys: keys });
        });
      });
    }
  }, {
