...
var ClassesRouter = exports.ClassesRouter = function (_PromiseRouter) {
  ...
  function ClassesRouter() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(ClassesRouter).apply(this, arguments));
  }
  ...
  _createClass(ClassesRouter, [{
    ...
    value: function handleGet(req) {
      ...
      return _rest2.default.get(req.config, req.auth, req.params.className, req.params.objectId, options).then(function (response) {
    ...
    value: function handleUpdate(req) {
      return _rest2.default.update(req.config, req.auth, req.params.className, req.params.objectId, req.body);
    }
  }, {
    key: 'handleDelete',
    ...
    value: function JSONFromQuery(query) {
      ...
      try {
        for (var _iterator4 = Object.entries(query)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
