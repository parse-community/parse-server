...
var InstallationsRouter = exports.InstallationsRouter = function (_ClassesRouter) {
  ...
  function InstallationsRouter() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(InstallationsRouter).apply(this, arguments));
  }
  ...
  _createClass(InstallationsRouter, [{
    ...
    value: function handleFind(req) {
      ...
      return _rest2.default.find(req.config, req.auth, '_Installation', body.where, options).then(function (response) {
    ...
    value: function handleGet(req) {
      ...
      return _get(Object.getPrototypeOf(InstallationsRouter.prototype), 'handleGet', this).call(this, req);
    }
  }, {
    key: 'handleCreate',
    value: function handleCreate(req) {
      req.params.className = '_Installation';
      return _get(Object.getPrototypeOf(InstallationsRouter.prototype), 'handleCreate', this).call(this, req);
    }
  }, {
    key: 'handleUpdate',
    value: function handleUpdate(req) {
      req.params.className = '_Installation';
      return _get(Object.getPrototypeOf(InstallationsRouter.prototype), 'handleUpdate', this).call(this, req);
    }
  }, {
    key: 'handleDelete',
    value: function handleDelete(req) {
      req.params.className = '_Installation';
      return _get(Object.getPrototypeOf(InstallationsRouter.prototype), 'handleDelete', this).call(this, req);
    }
  }, {
    key: 'mountRoutes',
