...
var PublicAPIRouter = exports.PublicAPIRouter = function (_PromiseRouter) {
  ...
  function PublicAPIRouter() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(PublicAPIRouter).apply(this, arguments));
  }
  ...
  _createClass(PublicAPIRouter, [{
    ...
    value: function requestResetPassword(req) {
      ...
      var username = _req$query2.username;
      var token = _req$query2.token;
    ...
    value: function resetPassword(req) {
      ...
      var new_password = _req$body.new_password;
    ...
    value: function expressApp() {
      ...
      router.use("/", _get(Object.getPrototypeOf(PublicAPIRouter.prototype), 'expressApp', this).call(this));
      return router;
    }
  }]);
