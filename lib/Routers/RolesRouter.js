...
var RolesRouter = exports.RolesRouter = function (_ClassesRouter) {
  ...
  function RolesRouter() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(RolesRouter).apply(this, arguments));
  }
  ...
  _createClass(RolesRouter, [{
    ...
    value: function handleFind(req) {
      ...
      return _get(Object.getPrototypeOf(RolesRouter.prototype), 'handleFind', this).call(this, req);
    }
  }, {
    key: 'handleGet',
    value: function handleGet(req) {
      req.params.className = '_Role';
      return _get(Object.getPrototypeOf(RolesRouter.prototype), 'handleGet', this).call(this, req);
    }
  }, {
    key: 'handleCreate',
    value: function handleCreate(req) {
      req.params.className = '_Role';
      return _get(Object.getPrototypeOf(RolesRouter.prototype), 'handleCreate', this).call(this, req);
    }
  }, {
    key: 'handleUpdate',
    value: function handleUpdate(req) {
      req.params.className = '_Role';
      return _get(Object.getPrototypeOf(RolesRouter.prototype), 'handleUpdate', this).call(this, req);
    }
  }, {
    key: 'handleDelete',
    value: function handleDelete(req) {
      req.params.className = '_Role';
      return _get(Object.getPrototypeOf(RolesRouter.prototype), 'handleDelete', this).call(this, req);
    }
  }, {
    key: 'mountRoutes',
