...
var transformObjectACL = function transformObjectACL(_ref) {
  ...
  var result = _objectWithoutProperties(_ref, ['ACL']);
...
var specialQuerykeys = ['$and', '$or', '_rperm', '_wperm', '_perishable_token', '_email_verify_token', '_email_verify_token_expires_at'];
...
//         write permissions.
var specialKeysForUpdate = ['_hashed_password', '_perishable_token', '_email_verify_token', '_email_verify_token_expires_at'];
DatabaseController.prototype.update = function (className, query, update) {
  ...
  var skipSanitization = arguments.length <= 4 || arguments[4] === undefined ? false : arguments[4];
...
DatabaseController.prototype.find = function (className, query) {
  ...
  var acl = _ref6.acl;
  var _ref6$sort = _ref6.sort;
  var sort = _ref6$sort === undefined ? {} : _ref6$sort;
      ...
      return (isMaster ? Promise.resolve() : schemaController.validatePermission(className, aclGroup, op)).then(function () {
        ...
        if (count) {
          ...
          if (!classExists) {
            ...
            return _this10.adapter.find(className, schema, query, { skip: skip, limit: limit, sort: sort }).then(function (objects) {
...
var untransformObjectACL = function untransformObjectACL(_ref7) {
  ...
  var _wperm = _ref7._wperm;

  var output = _objectWithoutProperties(_ref7, ['_rperm', '_wperm']);
