...
var SchemaController = function () {
  ...
  _createClass(SchemaController, [{
    ...
    value: function reloadData() {
      ...
      var options = arguments.length <= 0 || arguments[0] === undefined ? { clearCache: false } : arguments[0];
      ...
      this.data = {};
      this.perms = {};
      this.reloadDataPromise = this.getAllClasses(options).then(function (allSchemas) {
    ...
    value: function getAllClasses() {
      ...
      return this._cache.getAllClasses().then(function (allClasses) {
    ...
    value: function getOneSchema(className) {
      ...
      var options = arguments.length <= 2 || arguments[2] === undefined ? { clearCache: false } : arguments[2];
      ...
      return this._cache.getOneSchema(className).then(function (cached) {
