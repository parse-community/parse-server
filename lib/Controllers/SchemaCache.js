...
var SchemaCache = function () {
  function SchemaCache(cacheController) {
    var ttl = arguments.length <= 1 || arguments[1] === undefined ? _defaults2.default.schemaCacheTTL : arguments[1];
    var frozen = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
