...
var UserController = exports.UserController = function (_AdaptableController) {
  ...
  function UserController(adapter, appId) {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(UserController).call(this, adapter, appId, options));
  }
  ...
  _createClass(UserController, [{
    ...
    value: function validateAdapter(adapter) {
      ...
      _get(Object.getPrototypeOf(UserController.prototype), 'validateAdapter', this).call(this, adapter);
    }
  }, {
    ...
    value: function verifyEmail(username, token) {
      ...
      }, { emailVerified: true }).then(function (document) {
        if (!document) {
          throw undefined;
        }
    ...
    value: function setPasswordResetToken(email) {
      return this.config.database.update('_User', { email: email }, { _perishable_token: (0, _cryptoUtils.randomString)(25) }, {}, true);
    }
  }, {
