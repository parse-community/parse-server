...
var _pushStatusHandler = require('../pushStatusHandler');

var _pushStatusHandler2 = _interopRequireDefault(_pushStatusHandler);
...
var PushController = exports.PushController = function (_AdaptableController) {
  ...
  _createClass(PushController, [{
    ...
    value: function sendPush() {
      ...
      var onPushStatusSaved = arguments.length <= 4 || arguments[4] === undefined ? function () {} : arguments[4];
      ...
      var pushStatus = (0, _pushStatusHandler2.default)(config);
      ...
      if (body.data && body.data.badge && typeof body.data.badge == 'string' && body.data.badge.toLowerCase() == "increment") {
        var _ret2 = function () {
          ...
          var promises = Object.keys(badgeInstallationsMap).map(function (badge) {
            ...
            return _this3.adapter.send(payload, badgeInstallationsMap[badge]);
          });
          return {
