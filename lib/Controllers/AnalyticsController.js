...
var AnalyticsController = exports.AnalyticsController = function (_AdaptableController) {
  ...
  function AnalyticsController() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(AnalyticsController).apply(this, arguments));
  }

  _createClass(AnalyticsController, [{
    key: 'appOpened',
    value: function appOpened(req) {
      return this.adapter.appOpened(req.body, req).then(function (response) {
    ...
    value: function trackEvent(req) {
      return this.adapter.trackEvent(req.params.eventName, req.body, req).then(function (response) {
        return { response: response };
      }).catch(function (err) {
        return { response: {} };
      });
