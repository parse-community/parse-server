...
var ParseServer = function () {
  function ParseServer(_ref) {
    ...
    var _ref$useOnlyFilesAdap = _ref.useOnlyFilesAdapter;
    var useOnlyFilesAdapter = _ref$useOnlyFilesAdap === undefined ? false : _ref$useOnlyFilesAdap;
    ...
    var databaseController = new _DatabaseController2.default(databaseAdapter);
    ...
    var emailUniqueness = userClassPromise.then(function () {
      ...
      _logger.logger.warn('Unabled to ensure uniqueness for user email addresses: ', error);
      return Promise.reject(error);
    });
    ...
    _cache2.default.put(appId, {
      ...
      useOnlyFilesAdapter: useOnlyFilesAdapter,
      appName: appName,
