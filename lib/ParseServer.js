...
var ParseServer = function () {
  function ParseServer(_ref) {
    ...
    var analyticsAdapter = _ref.analyticsAdapter;
    ...
    var logLevel = _ref$logLevel === undefined ? _defaults2.default.level : _ref$logLevel;
    ...
    var databaseURI = _ref$databaseURI === undefined ? _defaults2.default.DefaultMongoURI : _ref$databaseURI;
    ...
    var enableAnonymousUsers = _ref$enableAnonymousU === undefined ? _defaults2.default.enableAnonymousUsers : _ref$enableAnonymousU;
    var _ref$allowClientClass = _ref.allowClientClassCreation;
    var allowClientClassCreation = _ref$allowClientClass === undefined ? _defaults2.default.allowClientClassCreation : _ref$allowClientClass;
    ...
    var maxUploadSize = _ref$maxUploadSize === undefined ? _defaults2.default.maxUploadSize : _ref$maxUploadSize;
    var _ref$verifyUserEmails = _ref.verifyUserEmails;
    var verifyUserEmails = _ref$verifyUserEmails === undefined ? _defaults2.default.verifyUserEmails : _ref$verifyUserEmails;
    var _ref$preventLoginWith = _ref.preventLoginWithUnverifiedEmail;
    var preventLoginWithUnverifiedEmail = _ref$preventLoginWith === undefined ? _defaults2.default.preventLoginWithUnverifiedEmail : _ref$preventLoginWith;
    var emailVerifyTokenValidityDuration = _ref.emailVerifyTokenValidityDuration;
    var accountLockout = _ref.accountLockout;
    ...
    var sessionLength = _ref$sessionLength === undefined ? _defaults2.default.sessionLength : _ref$sessionLength;
    var _ref$expireInactiveSe = _ref.expireInactiveSessions;
    var expireInactiveSessions = _ref$expireInactiveSe === undefined ? _defaults2.default.expireInactiveSessions : _ref$expireInactiveSe;
    var _ref$revokeSessionOnP = _ref.revokeSessionOnPasswordReset;
    var revokeSessionOnPasswordReset = _ref$revokeSessionOnP === undefined ? _defaults2.default.revokeSessionOnPasswordReset : _ref$revokeSessionOnP;
    var _ref$schemaCacheTTL = _ref.schemaCacheTTL;
    var schemaCacheTTL = _ref$schemaCacheTTL === undefined ? _defaults2.default.schemaCacheTTL : _ref$schemaCacheTTL;
    var _ref$schemaCacheFroze = _ref.schemaCacheFrozen;
    var schemaCacheFrozen = _ref$schemaCacheFroze === undefined ? _defaults2.default.schemaCacheFrozen : _ref$schemaCacheFroze;
    ...
    var databaseController = new _DatabaseController2.default(databaseAdapter, new _SchemaCache2.default(cacheController, schemaCacheTTL, schemaCacheFrozen));
    ...
    _cache2.default.put(appId, {
      ...
      schemaCacheFrozen: schemaCacheFrozen
    });
