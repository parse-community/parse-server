...
var ParseServer = function () {
  function ParseServer(_ref) {
    ...
    var _ref$freezeSchema = _ref.freezeSchema;
    var freezeSchema = _ref$freezeSchema === undefined ? _defaults2.default.freezeSchema : _ref$freezeSchema;
    ...
    var schemaCache = new _SchemaCache2.default(cacheController, schemaCacheTTL, freezeSchema);
    var databaseController = new _DatabaseController2.default(databaseAdapter, schemaCache);
